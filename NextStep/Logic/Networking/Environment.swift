...
enum Environment {
    ...
    var jwtPublicKey: Data {
        switch self {
        case .dev:
            return Data(base64Encoded: "LS0tLS1CRUdJTiBQVUJMSUMgS0VZLS0tLS0KTUZrd0V3WUhLb1pJemowQ0FRWUlLb1pJemowREFRY0RRZ0FFMmhtVXZUak5BbHhYNUVjUitsaGptV3AzTEwxWgp1ejdBQUdrSFg4d1Q1c0drWjkrdjZnSloxMjQ2TVNBT09tcVNoRURWeHFDaW8ra0FIbTRDNUx0M0R3PT0KLS0tLS1FTkQgUFVCTElDIEtFWS0tLS0t")!
        case .prod:
            return Data(base64Encoded: "LS0tLS1CRUdJTiBQVUJMSUMgS0VZLS0tLS0KTUZrd0V3WUhLb1pJemowQ0FRWUlLb1pJemowREFRY0RRZ0FFMmhtVXZUak5BbHhYNUVjUitsaGptV3AzTEwxWgp1ejdBQUdrSFg4d1Q1c0drWjkrdjZnSloxMjQ2TVNBT09tcVNoRURWeHFDaW8ra0FIbTRDNUx0M0R3PT0KLS0tLS1FTkQgUFVCTElDIEtFWS0tLS0t")!
        }
    }
