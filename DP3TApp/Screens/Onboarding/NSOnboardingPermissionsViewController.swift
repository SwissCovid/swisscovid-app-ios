...
class NSOnboardingPermissionsViewController: NSOnboardingContentViewController {
    ...
    private func fillViews() {
        ...
        case .gapple:
            ...
            let info2 = NSInfoView(icon: UIImage(named: "ic-battery")!, text: "onboarding_gaen_info_text_2".ub_localized, title: "onboarding_gaen_info_title_2".ub_localized, dynamicIconTintColor: .ns_blue)
        ...
        case .push:
            ...
            let info = NSInfoView(icon: UIImage(named: "ic-report")!, text: "onboarding_push_gtk_text1".ub_localized, title: "onboarding_push_gtk_title1".ub_localized, dynamicIconTintColor: .ns_blue)
