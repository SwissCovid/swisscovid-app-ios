...
struct OnboardingStepModel {
    ...
    static let step1 = OnboardingStepModel(heading: "onboarding_prinzip_heading".ub_localized,
    ...
    static let step2 = OnboardingStepModel(heading: "onboarding_privacy_heading".ub_localized,
    ...
    static let step3 = OnboardingStepModel(heading: "onboarding_begegnungen_heading".ub_localized,
                                             headingColor: .ns_blue,
    ...
    static let step5 = OnboardingStepModel(heading: "onboarding_meldung_heading".ub_localized,
                                             headingColor: .ns_blue,
