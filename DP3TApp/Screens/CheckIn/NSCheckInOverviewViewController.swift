...
class NSCheckInOverviewViewController: NSViewController {
    ...
    private func setupInfoViews() {
        ...
        let infoViewTwo = NSOnboardingInfoView(icon: UIImage(named: "ic-verified-user"), text: "checkin_footer_subtitle2".ub_localized, title: "checkin_footer_title2".ub_localized, leftRightInset: 0, dynamicIconTintColor: .ns_blue)
