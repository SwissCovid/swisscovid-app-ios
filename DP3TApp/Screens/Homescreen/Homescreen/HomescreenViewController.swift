...
class HomescreenViewController: TitleViewScrollViewController {
    ...
    private let handshakesModuleView = BegegnungenModuleView()
    ...
    private var lastState: InterfaceStateModel = .init()
    ...
    func updateState(_ state: InterfaceStateModel) {
    ...
    private func presentWhatToDoPositiveTest() {
        navigationController?.pushViewController(WhatToDoPositiveTestViewController(), animated: true)
    }
    ...
    @objc private func infoButtonPressed() {
        present(NavigationController(rootViewController: AboutViewController()), animated: true)
    }
