...
import UIKit
    ...
    class NSSynchronizationStatusDetailController: NSViewController {
        ...
        private func buildInfoViewLayout() {
            ...
            let infoQuestion = NSInfoView(icon: UIImage(named: "ic-sync")!, text: "synchronizations_view_info_answer".ub_localized, title: "synchronizations_view_info_question".ub_localized, leftRightInset: 0, dynamicIconTintColor: .ns_blue)
