...
class HomescreenInfoBoxView: UIView {
    ...
    var uiState: InterfaceStateModel.Homescreen.InfoBox? {
        didSet {
            if uiState != oldValue {
    ...
    let infoBoxView = InfoBoxView(title: "", subText: "", image: UIImage(named: "ic-info"), illustration: nil, titleColor: UIColor.white, subtextColor: UIColor.white, backgroundColor: .ns_darkBlueBackground, additionalText: "", additionalURL: "")
