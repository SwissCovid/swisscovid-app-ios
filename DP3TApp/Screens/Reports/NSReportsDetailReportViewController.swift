...
class NSReportsDetailReportViewController: NSTitleViewScrollViewController {
    ...
    private func setupLayout() {
        ...
        stackScrollView.addArrangedView(NSInfoView(icon: UIImage(named: "ic-call")!, text: "meldungen_meldungen_faq1_text".ub_localized, title: "meldungen_meldungen_faq1_title".ub_localized, leftRightInset: 0, dynamicIconTintColor: .ns_blue))
