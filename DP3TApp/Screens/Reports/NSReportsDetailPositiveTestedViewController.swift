...
class NSReportsDetailPositiveTestedViewController: NSTitleViewScrollViewController {
    ...
    private func setupLayout() {
        ...
        stackScrollView.addArrangedView(NSInfoView(icon: UIImage(named: "ic-tracing")!.ub_image(with: .ns_purple)!, text: "meldungen_positive_tested_faq1_text".ub_localized, title: "meldungen_positive_tested_faq1_title".ub_localized, leftRightInset: 0, dynamicIconTintColor: .ns_purple))
